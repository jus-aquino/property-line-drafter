...
class main_app:
    ...
    window.title('Property Lines Drafter')
...
def get_coordinates(distance, angle):
    if distance > 0 and angle != None:
        ...
        return tk.messagebox.showerror('Error', 'Distance must be greater than 0')
...
def DMS_to_DecDeg(NS, bearing, EW):
    ...
    if NS == 'N' and EW == 'E':
        ...
        if 90 >= angle >= 0:
            ...
            return tk.messagebox.showerror('Error', 'Bearing angle must be between 0º and 90º')
...
def draw():
    ...
    if is_closed() == False:
        ...
        try:
            ...
            return tk.messagebox.showerror('Error', 'No AutoCAD instance detected')
